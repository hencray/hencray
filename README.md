...
- **[trading-wiki](https://github.com/hencray/trading-wiki)** — Framework for ingesting trading content (videos, Discord, pasted text), running multi-pass LLM extraction with versioned prompts, and acid-testing strategies via backtest → paper → live.
